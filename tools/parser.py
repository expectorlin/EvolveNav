...
def read_args():
    ...
    # evolvenav
    parser.add_argument("--IL_setting", action="store_true", default=False, help="add this in the script for IL training")
    parser.add_argument("--Stage_2_training", action="store_true", default=False, help="")
    ...
    parser.add_argument('--self_reflective_loss_weight', type=float, default=0.2, help="")
